...
//             <button onClick={() => setShowAddForm(!showAddForm)} className="mb-4 flex items-center justify-center">
//                 <GrAdd size={'2em'} color='red' />
//                 {showAddForm ? 'Fermer le formulaire' : 'Ajouter une région'}
//             </button>
...
const ListRegion = () => {
    ...
    const handleUpdate = async (id) => {
        try {
            ...
            const response = await axios.put(`http://127.0.0.1:8000/api/regions/${id}`, formData, {
                headers: {
