            ...
            if (user) {
              return (
                <div className="hs-dropdown relative inline-flex">
                  ...
                  <div
                    className={`hs-dropdown-menu transition-[opacity,margin] duration ${isDropdownOpen ? 'opacity-100' : 'opacity-0 hidden'
                      } min-w-10 bg-sky-500 shadow-md rounded-lg mt-2`}
...
//   <div className={`hs-dropdown-menu transition-[opacity,margin] duration ${isDropdownOpen ? 'opacity-100' : 'opacity-0 hidden'} min-w-10 bg-sky-500 shadow-md rounded-lg  mt-2`} aria-labelledby="hs-dropdown-default">
