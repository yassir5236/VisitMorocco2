                ...
                <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative">
                      <label className="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Upload file</label>
                      <input
                        className="block w-full text-sm p-1 text-black border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-cyan-100 dark:border-gray-400 dark:placeholder-gray-900"
                        onChange={(e) => setImage(e.target.files[0])}
                        type="file"
                        id="image"
                        name="image"
                  ...
                  <p className="text-sm font-light text-gray-500 dark:text-gray-400">Already have an account?
                    <Link className="font-medium text-blue-400 hover:underline dark:text-blue-400" to="/Login">Sign in here</Link>
                  </p>
                </div>
              </div>
            </div>
